<?php
echo $banjara_name=$_POST['name'];
echo $banjara_number=$_POST['number'];
...
$sql="INSERT INTO humbanjara(FULL NAME,MAIL ID,PASSWORD,COUNTRY,STATE,PHOTO,MOBILE NUMBER) VALUES('{$banjara_name}','{$banjara_number}','{$banjara_mail}','{$banjara_password}','{$banjara_country}','{$banjara_state}','{$banjara_photo}')"; //connetion values insert cheyadam
